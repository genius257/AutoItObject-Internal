...
Func testTypeSupport()
	...
	$oIDispatch.a = Ptr(1)
	assertEquals(@error, 0)
	assertInternalType($oIDispatch.a, "Ptr", "Fail is exspected, AutoIt related, not a fault of the library")
	$oIDispatch.a = HWnd(1)
	assertEquals(@error, 0)
	assertInternalType($oIDispatch.a, "HWnd", "Fail is exspected, AutoIt related, not a fault of the library")
	$oIDispatch.a = True
	assertEquals(@error, 0)
